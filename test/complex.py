...
# Create elements
mesh.add_element([1,2], "entrait", "r", h, b) #1
mesh.add_element([2,3], "entrait", "r", h, b) #2
mesh.add_element([3,4], "entrait", "r", h, b) #1
mesh.add_element([4,5], "entrait", "r", h, b) #2
